export const slackSystemInstructions = [
  [
    "Buddy SOS Slack is available as an opencode plugin.",
    ...
    "slack_send_message_draft is currently an explicit blocked-feature exception until Buddy SOS has a Slack-supported ChatGPT-style attached draft API path.",
  ].join(" "),
]
